    ...
    return (
        <div className="w-full min-h-screen bg-[#f5f3f0] dark:bg-[#0a0a0a] text-[#0a0a0a] dark:text-[#f5f3f0] selection:bg-[#ff6b35]/30 font-sans overflow-x-hidden transition-colors duration-500">
            ...
            <div className="fixed inset-0 pointer-events-none -z-10 bg-[#f5f3f0] dark:bg-[#0a0a0a] transition-colors duration-500">
                <div className="absolute top-0 right-0 w-[70vw] h-[70vw] bg-[#ff6b35]/5 rounded-full blur-[180px] animate-pulse" />
                <div className="absolute bottom-0 left-0 w-[60vw] h-[60vw] bg-[#ff6b35]/5 rounded-full blur-[180px]" />
            </div>
            ...
            <main className="relative min-h-screen flex flex-col items-center justify-center px-3 sm:px-4 md:px-6 py-10 sm:py-14 md:py-20 overflow-hidden">
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-white dark:from-[#1a1a1a] to-[#ebdcd0]/40 dark:to-[#0a0a0a] transition-colors duration-500">
                        <div className="absolute inset-0 bg-black/5 dark:bg-black/40 group-hover:bg-black/2 dark:group-hover:bg-black/20 transition-colors duration-700" />
                    </div>

                    {/* Gradient Overlays */}
                    <div className="absolute inset-0 bg-linear-to-t from-white dark:from-black via-white/40 dark:via-black/40 to-transparent transition-colors duration-500" />
                    <div className="absolute inset-0 bg-linear-to-r from-white dark:from-black via-transparent to-transparent opacity-40 dark:opacity-85 transition-colors duration-500" />
                    ...
                    <div className="absolute inset-0 p-4 sm:p-6 md:p-10 lg:p-16 flex flex-col justify-end">
                        ...
                        >
                            <div className="flex flex-wrap items-center gap-2 sm:gap-3 md:gap-4 text-slate-800 dark:text-white transition-colors duration-500">
                                <span className="px-2 py-0.5 sm:px-3 sm:py-1 bg-white/80 dark:bg-[#1a1a1a] backdrop-blur-md rounded-md text-[8px] sm:text-[10px] font-bold uppercase tracking-widest border border-[#e5e5e5] dark:border-[#2a2a2a] text-[#0a0a0a] dark:text-[#f5f3f0]">4K ULTRA HD</span>
                                <span className="flex items-center gap-1 sm:gap-1.5 px-2 py-0.5 sm:px-3 sm:py-1 bg-[#ff6b35]/15 backdrop-blur-md rounded-md text-[8px] sm:text-[10px] font-bold uppercase tracking-widest border border-[#ff6b35]/25 text-[#ff6b35]">
                                    <Star className="w-2.5 h-2.5 sm:w-3 sm:h-3 fill-current" /> Premium Exclusive
                                </span>
                            </div>

                            <h1 className="text-lg sm:text-xl md:text-3xl lg:text-5xl font-light font-serif leading-[1.2] text-[#0a0a0a] dark:text-[#f5f3f0] drop-shadow-2xl pt-2 sm:pt-4 md:pt-6 transition-colors duration-500">
                                {videoMedia.title}
                            </h1>

                            <p className="text-slate-600 dark:text-[#888888] text-xs sm:text-sm md:text-base lg:text-lg max-w-2xl font-light leading-relaxed line-clamp-2 md:line-clamp-3 transition-colors duration-500">
                            ...
                            <div className="flex flex-wrap items-center gap-2 sm:gap-3 md:gap-4 pt-2 sm:pt-3 md:pt-4">
                                <button
                                    ...
                                    className="group/btn px-5 py-2.5 sm:px-7 sm:py-3 md:px-10 md:py-5 bg-[#ff6b35] text-white rounded-xl sm:rounded-2xl font-bold uppercase text-[10px] sm:text-xs tracking-[0.2em] shadow-[0_12px_24px_rgba(255,107,53,0.25)] hover:bg-[#ff8c5a] transition-all transform hover:scale-105 flex items-center gap-2 sm:gap-3 active:scale-95"
                                >
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2.5 sm:px-6 sm:py-3 md:px-8 md:py-5 backdrop-blur-xl rounded-xl sm:rounded-2xl font-bold uppercase text-[10px] sm:text-xs tracking-[0.2em] border transition-all flex items-center gap-2 sm:gap-3 active:scale-95 ${isInPlaylist
                                        ? 'bg-[#ff6b35]/20 border-[#ff6b35]/40 text-[#ff6b35]'
                                        : 'bg-white/80 dark:bg-[#1a1a1a]/50 border-[#e5e5e5] dark:border-[#2a2a2a] text-slate-500 dark:text-[#888888] hover:bg-slate-100 dark:hover:bg-[#1a1a1a] hover:border-[#ff6b35]/30 hover:text-[#0a0a0a] dark:hover:text-[#f5f3f0]'
                                        }`}
                                >
                                ...
                                <button className="p-2.5 sm:p-3 md:p-5 bg-white/80 dark:bg-[#1a1a1a]/50 border border-[#e5e5e5] dark:border-[#2a2a2a] text-slate-500 dark:text-[#888888] hover:bg-slate-100 dark:hover:bg-[#1a1a1a] hover:border-[#ff6b35]/30 hover:text-[#0a0a0a] dark:hover:text-[#f5f3f0] backdrop-blur-xl rounded-xl sm:rounded-2xl transition-all active:scale-95">
                    ...
                    <div className="absolute top-10 right-10 flex gap-2">
                        {[1, 2, 3].map(i => (
                            <motion.div
                                ...
                                className="w-1.5 h-1.5 rounded-full bg-[#ff6b35] shadow-[0_0_10px_#ff6b35]"
                            />
                        ))}
                    </div>
                </motion.div>
                ...
                <div className="w-full max-w-6xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mt-6 sm:mt-8 md:mt-12">
                    <div className="p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl md:rounded-4xl glass-panel-light space-y-2 sm:space-y-4">
                        <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-[#ff6b35]" />
                        <h3 className="text-xs sm:text-sm font-bold uppercase tracking-widest text-[#0a0a0a] dark:text-[#f5f3f0]">Duration</h3>
                        <p className="text-xl sm:text-2xl font-bold text-[#0a0a0a] dark:text-[#f5f3f0]">12:45 <span className="text-xs sm:text-sm text-[#888888] font-normal">MIN</span></p>
                    </div>
                    <div className="p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl md:rounded-4xl glass-panel-light space-y-2 sm:space-y-4 sm:col-span-1 md:col-span-2">
                        <Info className="w-5 h-5 sm:w-6 sm:h-6 text-[#ff6b35]" />
                        <h3 className="text-xs sm:text-sm font-bold uppercase tracking-widest text-[#0a0a0a] dark:text-[#f5f3f0]">About the Film</h3>
                ...
                {showPlayer && (
                    ...
                    >
                        <motion.div
                            ...
                            className="relative w-full max-w-7xl aspect-video bg-black rounded-xl sm:rounded-2xl md:rounded-3xl lg:rounded-4xl overflow-hidden shadow-[0_0_100px_rgba(255,107,53,0.15)]"
                        >
